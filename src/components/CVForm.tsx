...
import { Plus, Trash2, Upload, User, Briefcase, GraduationCap, Award, Languages, Target, X, QrCode, Share2 } from "lucide-react";
...
export function CVForm({ onSubmit, initialData, onRestrictedAccess, currentCVId }: CVFormProps) {
  const { t } = useLanguage();
  ...
  // Helper function to capitalize first letter of each word (without forcing lowercase)
  ...
  const handlePhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      // Convert to base64 data URL for cropping
      ...
      // Show cropper dialog with the image
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => {
                ...
                setFormData({
                  ...formData,
                  personalInfo: { ...formData.personalInfo, fullName: capitalizedValue },
                });
              }}
      ...
      <Card className="p-6">
        <div className="flex items-center gap-3 mb-6">
          <div className="bg-cyan-100 p-2 rounded-lg">
            <Share2 className="text-cyan-600" size={24} />
          </div>
          <h2 className="text-2xl">{t.socialPlatform}</h2>
        </div>
