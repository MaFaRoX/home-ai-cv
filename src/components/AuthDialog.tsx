...
export function AuthDialog({ open, onOpenChange, isGuestRestriction = false }: AuthDialogProps) {
  ...
  // Render hidden Google button when dialog opens
  useEffect(() => {
    if (!open || !window.google || !hiddenGoogleButtonRef) return;
